...
class GetAllUsersRouteTests(BaseAPITest):
    ...
    def test_get_all_users_return_all_users_when_users_exist(self) -> None:
        ...
        self.client.post("/v1/auth/register", json=admin_data)
        ...
        login_response = self.client.post("/v1/auth/login", json=admin_data)
        ...
        self.client.post("/v1/auth/register", json=user_1)
        self.client.post("/v1/auth/register", json=user_2)
        ...
        self.assertEqual(len(response_data["users"]), 3)  # admin + 2 users
