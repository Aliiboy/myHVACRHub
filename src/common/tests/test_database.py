...
class DatabaseTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls: type["DatabaseTests"]) -> None:
    ...
    def setUp(self: "DatabaseTests") -> None:
    ...
    def test_get_session_returns_valid_session(self: "DatabaseTests") -> None:
    ...
    def test_get_session_raises_exception_on_error(self: "DatabaseTests") -> None:
